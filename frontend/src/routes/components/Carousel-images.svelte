...
<div id="carousel-container">
  <div id="carousel-images">
    ...
    <div class="carousel-item" id={image.id}>
      <div class="max-w-md rounded overflow-hidden shadow-lg float-left m-4 bg-white coursel-img block">
        <div class="px-6 py-4 m">
            <div class="font-bold text-xl mb-2 cursor-pointer">title{image.id}</div>
            <p class="text-gray-700 text-base">description{image.id}</p>
        </div>
        </div>
